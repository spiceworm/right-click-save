...
class Token:
    def __init__(self, address, id_, metadata, raw, category):
            ...
            for erc721_token in account["tokens"]:
                ...
                try:
                    ...
                    if token_uri := erc721_token["uri"]:
                        ...
                        yield cls(token_address, token_id_hash, metadata, erc721_token, "Token")
                    elif token_address == addresses.ENS:
                        domain = the_graph.query_ens_by_labelhash(token_id_hash)
                        metadata = {"name": domain}
                        yield cls(token_address, token_id_hash, metadata, erc721_token, "ENS")
                        ...
                        metadata = {"name": name}
                        yield cls(token_address, token_id_hash, metadata, erc721_token, "Decentraland")
                    else:
